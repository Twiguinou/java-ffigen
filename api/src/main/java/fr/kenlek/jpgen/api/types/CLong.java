...
public final class CLong
{
    ...
    public static final DowncallTransformer TRANSFORMER = (method, handle) ->
    {
        final class Container
        {
            ...
            static
            {
                try
                {
                    ...
                    WRAPPER = lookup.findStatic(CLong.class, "of", methodType(CLong.class, LAYOUT.carrier()));
                    UNWRAPPER = lookup.findGetter(CLong.class, "value", long.class).asType(methodType(LAYOUT.carrier(), CLong.class));
                }
        ...
        if (method.getReturnType().equals(CLong.class) && handle.type().returnType().equals(LAYOUT.carrier()))
        {
        ...
        {
            if (parameterTypes[i].equals(CLong.class) && handle.type().parameterType(i).equals(LAYOUT.carrier()))
            {
