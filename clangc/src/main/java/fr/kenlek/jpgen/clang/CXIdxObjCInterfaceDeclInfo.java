...
public record CXIdxObjCInterfaceDeclInfo(MemorySegment ptr)
{
    ...
    {
        return this.ptr().get(UNBOUNDED_POINTER, OFFSET__superInfo);
    }

    public void superInfo(MemorySegment value)
    {
        this.ptr().set(UNBOUNDED_POINTER, OFFSET__superInfo, value);
    }

    public MemorySegment $superInfo()
    {
        return this.ptr().asSlice(OFFSET__superInfo, UNBOUNDED_POINTER);
    }
