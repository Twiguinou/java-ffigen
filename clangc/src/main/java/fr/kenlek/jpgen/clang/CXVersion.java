...
public record CXVersion(MemorySegment ptr)
{
    ...
    public int Major() {return this.ptr().get(JAVA_INT, OFFSET__Major);}
    public void Major(int value) {this.ptr().set(JAVA_INT, OFFSET__Major, value);}
    public MemorySegment $Major() {return this.ptr().asSlice(OFFSET__Major, JAVA_INT);}

    public int Minor() {return this.ptr().get(JAVA_INT, OFFSET__Minor);}
    public void Minor(int value) {this.ptr().set(JAVA_INT, OFFSET__Minor, value);}
    public MemorySegment $Minor() {return this.ptr().asSlice(OFFSET__Minor, JAVA_INT);}

    public int Subminor() {return this.ptr().get(JAVA_INT, OFFSET__Subminor);}
    public void Subminor(int value) {this.ptr().set(JAVA_INT, OFFSET__Subminor, value);}
    public MemorySegment $Subminor() {return this.ptr().asSlice(OFFSET__Subminor, JAVA_INT);}
}
