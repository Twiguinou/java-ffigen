...
public interface LibClang
{
    ...
    CXString constructUSR_ObjCMethod(@Ignore SegmentAllocator $segmentAllocator, MemorySegment name, @Layout("int") boolean isInstanceMethod, CXString classUSR);
    ...
    CXString getFullyQualifiedName(@Ignore SegmentAllocator $segmentAllocator, CXType CT, MemorySegment Policy, @Layout("int") boolean WithGlobalNsPrefix);
