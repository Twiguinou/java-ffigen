...
public record CXIdxLoc(MemorySegment ptr)
{
    ...
    public int int_data()
    {
        return this.ptr().get(JAVA_INT, OFFSET__int_data);
    }

    public void int_data(int value)
    {
        this.ptr().set(JAVA_INT, OFFSET__int_data, value);
    }

    public MemorySegment $int_data()
    {
        return this.ptr().asSlice(OFFSET__int_data, JAVA_INT);
    }
}
