...
public record CXSourceRange(MemorySegment ptr)
{
    ...
    public int begin_int_data() {return this.ptr().get(JAVA_INT, OFFSET__begin_int_data);}
    public void begin_int_data(int value) {this.ptr().set(JAVA_INT, OFFSET__begin_int_data, value);}
    public MemorySegment $begin_int_data() {return this.ptr().asSlice(OFFSET__begin_int_data, JAVA_INT);}

    public int end_int_data() {return this.ptr().get(JAVA_INT, OFFSET__end_int_data);}
    public void end_int_data(int value) {this.ptr().set(JAVA_INT, OFFSET__end_int_data, value);}
    public MemorySegment $end_int_data() {return this.ptr().asSlice(OFFSET__end_int_data, JAVA_INT);}
}
