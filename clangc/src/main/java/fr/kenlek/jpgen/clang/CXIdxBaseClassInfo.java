...
public record CXIdxBaseClassInfo(MemorySegment ptr)
{
    ...
    {
        return this.ptr().get(UNBOUNDED_POINTER, OFFSET__base);
    }

    public void base(MemorySegment value)
    {
        this.ptr().set(UNBOUNDED_POINTER, OFFSET__base, value);
    }

    public MemorySegment $base()
    {
        return this.ptr().asSlice(OFFSET__base, UNBOUNDED_POINTER);
    }
