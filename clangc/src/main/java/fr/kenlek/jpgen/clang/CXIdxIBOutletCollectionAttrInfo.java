...
public record CXIdxIBOutletCollectionAttrInfo(MemorySegment ptr)
{
    ...
    public MemorySegment attrInfo() {return this.ptr().get(UNBOUNDED_POINTER, OFFSET__attrInfo);}
    public void attrInfo(MemorySegment value) {this.ptr().set(UNBOUNDED_POINTER, OFFSET__attrInfo, value);}
    public MemorySegment $attrInfo() {return this.ptr().asSlice(OFFSET__attrInfo, UNBOUNDED_POINTER);}
