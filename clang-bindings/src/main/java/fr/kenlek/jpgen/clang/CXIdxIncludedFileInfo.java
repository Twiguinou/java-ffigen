...
public record CXIdxIncludedFileInfo(MemorySegment ptr)
{
    ...
    public CXIdxLoc hashLoc() {return new CXIdxLoc(this.ptr().asSlice(OFFSET__hashLoc, CXIdxLoc.LAYOUT));}
    public void hashLoc(Consumer<CXIdxLoc> consumer) {consumer.accept(this.hashLoc());}
    public void hashLoc(CXIdxLoc value) {MemorySegment.copy(value.ptr(), 0, this.ptr(), OFFSET__hashLoc, CXIdxLoc.LAYOUT.byteSize());}
    public MemorySegment $hashLoc() {return this.ptr().asSlice(OFFSET__hashLoc, CXIdxLoc.LAYOUT);}

    public MemorySegment filename() {return this.ptr().get(UNBOUNDED_POINTER, OFFSET__filename);}
    public void filename(MemorySegment value) {this.ptr().set(UNBOUNDED_POINTER, OFFSET__filename, value);}
    public MemorySegment $filename() {return this.ptr().asSlice(OFFSET__filename, UNBOUNDED_POINTER);}
    ...
    public int isImport() {return this.ptr().get(JAVA_INT, OFFSET__isImport);}
    public void isImport(int value) {this.ptr().set(JAVA_INT, OFFSET__isImport, value);}
    public MemorySegment $isImport() {return this.ptr().asSlice(OFFSET__isImport, JAVA_INT);}

    public int isAngled() {return this.ptr().get(JAVA_INT, OFFSET__isAngled);}
    public void isAngled(int value) {this.ptr().set(JAVA_INT, OFFSET__isAngled, value);}
    public MemorySegment $isAngled() {return this.ptr().asSlice(OFFSET__isAngled, JAVA_INT);}

    public int isModuleImport() {return this.ptr().get(JAVA_INT, OFFSET__isModuleImport);}
    public void isModuleImport(int value) {this.ptr().set(JAVA_INT, OFFSET__isModuleImport, value);}
    public MemorySegment $isModuleImport() {return this.ptr().asSlice(OFFSET__isModuleImport, JAVA_INT);}
}
