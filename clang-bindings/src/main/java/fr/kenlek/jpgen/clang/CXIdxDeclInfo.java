...
public record CXIdxDeclInfo(MemorySegment ptr)
{
    ...
    public MemorySegment entityInfo() {return this.ptr().get(UNBOUNDED_POINTER, OFFSET__entityInfo);}
    public void entityInfo(MemorySegment value) {this.ptr().set(UNBOUNDED_POINTER, OFFSET__entityInfo, value);}
    public MemorySegment $entityInfo() {return this.ptr().asSlice(OFFSET__entityInfo, UNBOUNDED_POINTER);}
    ...
    public MemorySegment semanticContainer() {return this.ptr().get(UNBOUNDED_POINTER, OFFSET__semanticContainer);}
    public void semanticContainer(MemorySegment value) {this.ptr().set(UNBOUNDED_POINTER, OFFSET__semanticContainer, value);}
    public MemorySegment $semanticContainer() {return this.ptr().asSlice(OFFSET__semanticContainer, UNBOUNDED_POINTER);}

    public MemorySegment lexicalContainer() {return this.ptr().get(UNBOUNDED_POINTER, OFFSET__lexicalContainer);}
    public void lexicalContainer(MemorySegment value) {this.ptr().set(UNBOUNDED_POINTER, OFFSET__lexicalContainer, value);}
    public MemorySegment $lexicalContainer() {return this.ptr().asSlice(OFFSET__lexicalContainer, UNBOUNDED_POINTER);}

    public int isRedeclaration() {return this.ptr().get(JAVA_INT, OFFSET__isRedeclaration);}
    public void isRedeclaration(int value) {this.ptr().set(JAVA_INT, OFFSET__isRedeclaration, value);}
    public MemorySegment $isRedeclaration() {return this.ptr().asSlice(OFFSET__isRedeclaration, JAVA_INT);}

    public int isDefinition() {return this.ptr().get(JAVA_INT, OFFSET__isDefinition);}
    public void isDefinition(int value) {this.ptr().set(JAVA_INT, OFFSET__isDefinition, value);}
    public MemorySegment $isDefinition() {return this.ptr().asSlice(OFFSET__isDefinition, JAVA_INT);}

    public int isContainer() {return this.ptr().get(JAVA_INT, OFFSET__isContainer);}
    public void isContainer(int value) {this.ptr().set(JAVA_INT, OFFSET__isContainer, value);}
    public MemorySegment $isContainer() {return this.ptr().asSlice(OFFSET__isContainer, JAVA_INT);}

    public MemorySegment declAsContainer() {return this.ptr().get(UNBOUNDED_POINTER, OFFSET__declAsContainer);}
    public void declAsContainer(MemorySegment value) {this.ptr().set(UNBOUNDED_POINTER, OFFSET__declAsContainer, value);}
    public MemorySegment $declAsContainer() {return this.ptr().asSlice(OFFSET__declAsContainer, UNBOUNDED_POINTER);}
    ...
    public int flags() {return this.ptr().get(JAVA_INT, OFFSET__flags);}
    public void flags(int value) {this.ptr().set(JAVA_INT, OFFSET__flags, value);}
    public MemorySegment $flags() {return this.ptr().asSlice(OFFSET__flags, JAVA_INT);}
}
