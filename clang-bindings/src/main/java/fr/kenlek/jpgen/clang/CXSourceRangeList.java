...
public record CXSourceRangeList(MemorySegment ptr)
{
    ...
    public MemorySegment ranges() {return this.ptr().get(UNBOUNDED_POINTER, OFFSET__ranges);}
    public void ranges(MemorySegment value) {this.ptr().set(UNBOUNDED_POINTER, OFFSET__ranges, value);}
    public MemorySegment $ranges() {return this.ptr().asSlice(OFFSET__ranges, UNBOUNDED_POINTER);}
}
