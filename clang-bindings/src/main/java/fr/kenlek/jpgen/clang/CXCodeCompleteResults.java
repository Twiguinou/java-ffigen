...
public record CXCodeCompleteResults(MemorySegment ptr)
{
    ...
    public MemorySegment Results() {return this.ptr().get(UNBOUNDED_POINTER, OFFSET__Results);}
    public void Results(MemorySegment value) {this.ptr().set(UNBOUNDED_POINTER, OFFSET__Results, value);}
    public MemorySegment $Results() {return this.ptr().asSlice(OFFSET__Results, UNBOUNDED_POINTER);}

    public int NumResults() {return this.ptr().get(JAVA_INT, OFFSET__NumResults);}
    public void NumResults(int value) {this.ptr().set(JAVA_INT, OFFSET__NumResults, value);}
    public MemorySegment $NumResults() {return this.ptr().asSlice(OFFSET__NumResults, JAVA_INT);}
}
