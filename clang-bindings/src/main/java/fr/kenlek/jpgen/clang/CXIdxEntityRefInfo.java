...
public record CXIdxEntityRefInfo(MemorySegment ptr)
{
    ...
    public MemorySegment referencedEntity() {return this.ptr().get(UNBOUNDED_POINTER, OFFSET__referencedEntity);}
    public void referencedEntity(MemorySegment value) {this.ptr().set(UNBOUNDED_POINTER, OFFSET__referencedEntity, value);}
    public MemorySegment $referencedEntity() {return this.ptr().asSlice(OFFSET__referencedEntity, UNBOUNDED_POINTER);}

    public MemorySegment parentEntity() {return this.ptr().get(UNBOUNDED_POINTER, OFFSET__parentEntity);}
    public void parentEntity(MemorySegment value) {this.ptr().set(UNBOUNDED_POINTER, OFFSET__parentEntity, value);}
    public MemorySegment $parentEntity() {return this.ptr().asSlice(OFFSET__parentEntity, UNBOUNDED_POINTER);}

    public MemorySegment container() {return this.ptr().get(UNBOUNDED_POINTER, OFFSET__container);}
    public void container(MemorySegment value) {this.ptr().set(UNBOUNDED_POINTER, OFFSET__container, value);}
    public MemorySegment $container() {return this.ptr().asSlice(OFFSET__container, UNBOUNDED_POINTER);}

    public int role() {return this.ptr().get(JAVA_INT, OFFSET__role);}
    public void role(int value) {this.ptr().set(JAVA_INT, OFFSET__role, value);}
    public MemorySegment $role() {return this.ptr().asSlice(OFFSET__role, JAVA_INT);}
}
