...
public record CXType(java.lang.foreign.MemorySegment ptr)
{
    public static final java.lang.foreign.StructLayout LAYOUT = java.lang.foreign.MemoryLayout.structLayout(
            ...
            Layouts.ARRAY_2__POINTER.withName("data")
    ).withByteAlignment(8);
    ...
    public java.lang.foreign.MemorySegment data() {return this.ptr.asSlice(MEMBER_OFFSET__data, Layouts.ARRAY_2__POINTER);}
