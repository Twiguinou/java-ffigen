...
{
    public static final java.lang.foreign.StructLayout LAYOUT__hashLoc = fr.akshir.jpgen.clang.CXIdxLoc.gRecordLayout.withName("hashLoc");
    public static final long OFFSET__hashLoc = 0;
    public static final java.lang.foreign.AddressLayout LAYOUT__filename = fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER.withName("filename");
    public static final long OFFSET__filename = 24;
    public static final java.lang.foreign.AddressLayout LAYOUT__file = fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER.withName("file");
    ...
    public fr.akshir.jpgen.clang.CXIdxLoc hashLoc() {return new fr.akshir.jpgen.clang.CXIdxLoc(this.ptr.asSlice(OFFSET__hashLoc, LAYOUT__hashLoc));}
    public void hashLoc(java.util.function.Consumer<fr.akshir.jpgen.clang.CXIdxLoc> consumer) {consumer.accept(this.hashLoc());}
    public void hashLoc(fr.akshir.jpgen.clang.CXIdxLoc value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, OFFSET__hashLoc, LAYOUT__hashLoc.byteSize());}
