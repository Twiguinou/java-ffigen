...
{
    public static final java.lang.foreign.AddressLayout LAYOUT__declInfo = fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER.withName("declInfo");
    public static final long OFFSET__declInfo = 0;
    public static final java.lang.foreign.AddressLayout LAYOUT__getter = fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER.withName("getter");
    public static final long OFFSET__getter = 8;
    public static final java.lang.foreign.AddressLayout LAYOUT__setter = fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER.withName("setter");
