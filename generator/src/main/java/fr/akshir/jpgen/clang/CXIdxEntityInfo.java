...
public record CXIdxEntityInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.AddressLayout LAYOUT__name = fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER.withName("name");
    public static final long OFFSET__name = 16;
    public static final java.lang.foreign.AddressLayout LAYOUT__USR = fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER.withName("USR");
