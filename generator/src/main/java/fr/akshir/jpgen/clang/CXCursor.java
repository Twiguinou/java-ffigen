...
public record CXCursor(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.SequenceLayout LAYOUT__data = java.lang.foreign.MemoryLayout.sequenceLayout(3, fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER).withName("data");
