...
{
    public static final java.lang.foreign.SequenceLayout LAYOUT__ptr_data = java.lang.foreign.MemoryLayout.sequenceLayout(2, fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER).withName("ptr_data");
    public static final long OFFSET__ptr_data = 0;
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__begin_int_data = java.lang.foreign.ValueLayout.JAVA_INT.withName("begin_int_data");
    public static final long OFFSET__begin_int_data = 16;
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT__end_int_data = java.lang.foreign.ValueLayout.JAVA_INT.withName("end_int_data");
    ...
    public java.lang.foreign.MemorySegment ptr_data(int index) {return this.ptr_data().getAtIndex(fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER, index);}
    public void ptr_data(int index, java.lang.foreign.MemorySegment value) {this.ptr_data().setAtIndex(fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER, index, value);}
