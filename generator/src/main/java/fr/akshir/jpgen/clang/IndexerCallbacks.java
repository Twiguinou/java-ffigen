...
{
    public static final java.lang.foreign.AddressLayout LAYOUT__abortQuery = fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER.withName("abortQuery");
    public static final long OFFSET__abortQuery = 0;
    public static final java.lang.foreign.AddressLayout LAYOUT__diagnostic = fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER.withName("diagnostic");
    public static final long OFFSET__diagnostic = 8;
    public static final java.lang.foreign.AddressLayout LAYOUT__enteredMainFile = fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER.withName("enteredMainFile");
    public static final long OFFSET__enteredMainFile = 16;
    public static final java.lang.foreign.AddressLayout LAYOUT__ppIncludedFile = fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER.withName("ppIncludedFile");
    public static final long OFFSET__ppIncludedFile = 24;
    public static final java.lang.foreign.AddressLayout LAYOUT__importedASTFile = fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER.withName("importedASTFile");
    public static final long OFFSET__importedASTFile = 32;
    public static final java.lang.foreign.AddressLayout LAYOUT__startedTranslationUnit = fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER.withName("startedTranslationUnit");
    public static final long OFFSET__startedTranslationUnit = 40;
    public static final java.lang.foreign.AddressLayout LAYOUT__indexDeclaration = fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER.withName("indexDeclaration");
    public static final long OFFSET__indexDeclaration = 48;
    public static final java.lang.foreign.AddressLayout LAYOUT__indexEntityReference = fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER.withName("indexEntityReference");
