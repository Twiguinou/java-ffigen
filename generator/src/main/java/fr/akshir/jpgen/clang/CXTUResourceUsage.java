...
{
    public static final java.lang.foreign.AddressLayout LAYOUT__data = fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER.withName("data");
    ...
    public static final java.lang.foreign.AddressLayout LAYOUT__entries = fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER.withName("entries");
