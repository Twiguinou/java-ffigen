...
public record CXIndexOptions(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.AddressLayout LAYOUT__PreambleStoragePath = fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER.withName("PreambleStoragePath");
    public static final long OFFSET__PreambleStoragePath = 16;
    public static final java.lang.foreign.AddressLayout LAYOUT__InvocationEmissionPath = fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER.withName("InvocationEmissionPath");
