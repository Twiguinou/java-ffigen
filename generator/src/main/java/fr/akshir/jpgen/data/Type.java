...
import fr.akshir.jpgen.ClangUtils;
...
public interface Type
{
    ...
    class Pointer extends ValueBased
    {
        ...
        {
            super(ADDRESS, "fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER", "java.lang.foreign.AddressLayout", "java.lang.foreign.MemorySegment");
    ...
    record Array(Type elementType, long length) implements Type
    {
        ...
        public String getFunctionLayoutInstance()
        {
            return "fr.akshir.jpgen.NativeTypes.UNBOUNDED_POINTER";
        }
