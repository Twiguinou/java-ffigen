...
public record CXIdxObjCCategoryDeclInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final long MEMBER_OFFSET__protocols = ((72 / fr.kenlek.jpgen.ForeignUtils.UNBOUNDED_POINTER.byteSize()) * fr.kenlek.jpgen.ForeignUtils.UNBOUNDED_POINTER.byteSize());
