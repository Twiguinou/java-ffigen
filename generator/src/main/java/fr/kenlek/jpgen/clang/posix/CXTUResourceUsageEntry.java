...
public record CXTUResourceUsageEntry(java.lang.foreign.MemorySegment ptr) implements fr.kenlek.jpgen.clang.CXTUResourceUsageEntry
{
    ...
    {
        this(allocator.allocate(fr.kenlek.jpgen.clang.Layouts.RECORD_DECL__fr$kenlek$jpgen$clang$posix$CXTUResourceUsageEntry.layout));
    }

    public static final long MEMBER_OFFSET__kind = fr.kenlek.jpgen.clang.Layouts.RECORD_DECL__fr$kenlek$jpgen$clang$posix$CXTUResourceUsageEntry.state(0).byteOffset();
    ...
    public static final long MEMBER_OFFSET__amount = fr.kenlek.jpgen.clang.Layouts.RECORD_DECL__fr$kenlek$jpgen$clang$posix$CXTUResourceUsageEntry.state(1).byteOffset();
