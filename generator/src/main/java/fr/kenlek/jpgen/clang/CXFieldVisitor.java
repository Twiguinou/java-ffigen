...
{
    java.lang.foreign.FunctionDescriptor gDescriptor = java.lang.foreign.FunctionDescriptor.of(java.lang.foreign.ValueLayout.JAVA_INT, fr.kenlek.jpgen.clang.CXCursor.gRecordLayout, fr.kenlek.jpgen.NativeTypes.UNBOUNDED_POINTER);
    java.lang.invoke.MethodHandle gUpcallStub = fr.kenlek.jpgen.NativeTypes.initUpcallStub(gDescriptor, "_invoke", CXFieldVisitor.class);
