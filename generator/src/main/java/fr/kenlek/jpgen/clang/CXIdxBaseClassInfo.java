...
public record CXIdxBaseClassInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final long MEMBER_OFFSET__base = ((0 / fr.kenlek.jpgen.ForeignUtils.UNBOUNDED_POINTER.byteSize()) * fr.kenlek.jpgen.ForeignUtils.UNBOUNDED_POINTER.byteSize());
