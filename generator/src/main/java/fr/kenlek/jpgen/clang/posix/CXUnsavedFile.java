...
public record CXUnsavedFile(java.lang.foreign.MemorySegment ptr) implements fr.kenlek.jpgen.clang.CXUnsavedFile
{
    ...
    {
        this(allocator.allocate(fr.kenlek.jpgen.clang.Layouts.RECORD_DECL__fr$kenlek$jpgen$clang$posix$CXUnsavedFile.layout));
    }

    public static final long MEMBER_OFFSET__Filename = fr.kenlek.jpgen.clang.Layouts.RECORD_DECL__fr$kenlek$jpgen$clang$posix$CXUnsavedFile.state(0).byteOffset();
    ...
    public static final long MEMBER_OFFSET__Contents = fr.kenlek.jpgen.clang.Layouts.RECORD_DECL__fr$kenlek$jpgen$clang$posix$CXUnsavedFile.state(1).byteOffset();
    ...
    public static final long MEMBER_OFFSET__Length = fr.kenlek.jpgen.clang.Layouts.RECORD_DECL__fr$kenlek$jpgen$clang$posix$CXUnsavedFile.state(2).byteOffset();
