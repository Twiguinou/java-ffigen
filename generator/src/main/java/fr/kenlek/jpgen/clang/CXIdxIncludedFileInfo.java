...
public record CXIdxIncludedFileInfo(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final long MEMBER_OFFSET__hashLoc = ((0 / fr.kenlek.jpgen.clang.CXIdxLoc.LAYOUT.byteSize()) * fr.kenlek.jpgen.clang.CXIdxLoc.LAYOUT.byteSize());
    ...
    public static final long MEMBER_OFFSET__filename = ((24 / fr.kenlek.jpgen.ForeignUtils.UNBOUNDED_POINTER.byteSize()) * fr.kenlek.jpgen.ForeignUtils.UNBOUNDED_POINTER.byteSize());
    ...
    public static final long MEMBER_OFFSET__file = ((32 / fr.kenlek.jpgen.ForeignUtils.UNBOUNDED_POINTER.byteSize()) * fr.kenlek.jpgen.ForeignUtils.UNBOUNDED_POINTER.byteSize());
    ...
    public static final long MEMBER_OFFSET__isImport = ((40 / java.lang.foreign.ValueLayout.JAVA_INT.byteSize()) * java.lang.foreign.ValueLayout.JAVA_INT.byteSize());
    ...
    public static final long MEMBER_OFFSET__isAngled = ((44 / java.lang.foreign.ValueLayout.JAVA_INT.byteSize()) * java.lang.foreign.ValueLayout.JAVA_INT.byteSize());
    ...
    public static final long MEMBER_OFFSET__isModuleImport = ((48 / java.lang.foreign.ValueLayout.JAVA_INT.byteSize()) * java.lang.foreign.ValueLayout.JAVA_INT.byteSize());
