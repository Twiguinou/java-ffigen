...
{
    public static final fr.kenlek.jpgen.LayoutData<java.lang.foreign.StructLayout> LAYOUT_DATA = fr.kenlek.jpgen.ForeignUtils.LAYOUT_PROVIDER.createStruct("CXIdxIncludedFileInfo", java.util.List.of(
            new fr.kenlek.jpgen.Member.Field(fr.kenlek.jpgen.clang.CXIdxLoc.LAYOUT_DATA.layout.withName("hashLoc")),
    ...
    {
        return new CXIdxIncludedFileInfo(buffer.asSlice(index * LAYOUT_DATA.layout.byteSize(), LAYOUT_DATA.layout));
    }
    ...
    public static final long MEMBER_OFFSET__hashLoc = LAYOUT_DATA.state(0).byteOffset();
    public fr.kenlek.jpgen.clang.CXIdxLoc hashLoc() {return new fr.kenlek.jpgen.clang.CXIdxLoc(this.ptr.asSlice(MEMBER_OFFSET__hashLoc, fr.kenlek.jpgen.clang.CXIdxLoc.LAYOUT_DATA.layout));}
    public void hashLoc(java.util.function.Consumer<fr.kenlek.jpgen.clang.CXIdxLoc> consumer) {consumer.accept(this.hashLoc());}
    public void hashLoc(fr.kenlek.jpgen.clang.CXIdxLoc value) {java.lang.foreign.MemorySegment.copy(value.ptr(), 0, this.ptr, MEMBER_OFFSET__hashLoc, fr.kenlek.jpgen.clang.CXIdxLoc.LAYOUT_DATA.layout.byteSize());}
    public java.lang.foreign.MemorySegment $hashLoc() {return this.ptr.asSlice(MEMBER_OFFSET__hashLoc, fr.kenlek.jpgen.clang.CXIdxLoc.LAYOUT_DATA.layout);}

    public static final long MEMBER_OFFSET__filename = LAYOUT_DATA.state(1).byteOffset();
    ...
    public static final long MEMBER_OFFSET__file = LAYOUT_DATA.state(2).byteOffset();
    ...
    public static final long MEMBER_OFFSET__isImport = LAYOUT_DATA.state(3).byteOffset();
    ...
    public static final long MEMBER_OFFSET__isAngled = LAYOUT_DATA.state(4).byteOffset();
    ...
    public static final long MEMBER_OFFSET__isModuleImport = LAYOUT_DATA.state(5).byteOffset();
