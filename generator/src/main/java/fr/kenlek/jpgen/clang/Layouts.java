...
{private Layouts() {}
    ...
    public static final java.lang.foreign.SequenceLayout ARRAY_2__POINTER = java.lang.foreign.MemoryLayout.sequenceLayout(2, fr.kenlek.jpgen.ForeignUtils.UNBOUNDED_POINTER);
    public static final fr.kenlek.jpgen.LayoutData<java.lang.foreign.StructLayout> RECORD_DECL__fr$kenlek$jpgen$clang$CXSourceRange = fr.kenlek.jpgen.ForeignUtils.LAYOUT_PROVIDER.createStruct("CXSourceRange", java.util.List.of(
            new fr.kenlek.jpgen.Member.Field(ARRAY_2__POINTER.withName("ptr_data")),
    ...
    public static final java.lang.foreign.SequenceLayout ARRAY_3__POINTER = java.lang.foreign.MemoryLayout.sequenceLayout(3, fr.kenlek.jpgen.ForeignUtils.UNBOUNDED_POINTER);
    public static final fr.kenlek.jpgen.LayoutData<java.lang.foreign.StructLayout> RECORD_DECL__fr$kenlek$jpgen$clang$CXCursor = fr.kenlek.jpgen.ForeignUtils.LAYOUT_PROVIDER.createStruct("CXCursor", java.util.List.of(
            ...
            new fr.kenlek.jpgen.Member.Field(ARRAY_3__POINTER.withName("data"))
    ));
    ...
    public static final fr.kenlek.jpgen.LayoutData<java.lang.foreign.StructLayout> RECORD_DECL__fr$kenlek$jpgen$clang$CXIndexOptions = fr.kenlek.jpgen.ForeignUtils.LAYOUT_PROVIDER.createStruct("CXIndexOptions", java.util.List.of(
    ...
    public static final fr.kenlek.jpgen.LayoutData<java.lang.foreign.StructLayout> RECORD_DECL__fr$kenlek$jpgen$clang$CXType = fr.kenlek.jpgen.ForeignUtils.LAYOUT_PROVIDER.createStruct("CXType", java.util.List.of(
            new fr.kenlek.jpgen.Member.Field(java.lang.foreign.ValueLayout.JAVA_INT.withName("kind")),
            new fr.kenlek.jpgen.Member.Field(ARRAY_2__POINTER.withName("data"))
    ));
    ...
    public static final fr.kenlek.jpgen.LayoutData<java.lang.foreign.StructLayout> RECORD_DECL__fr$kenlek$jpgen$clang$win32$CXUnsavedFile = fr.kenlek.jpgen.ForeignUtils.LAYOUT_PROVIDER.createStruct("CXUnsavedFile", java.util.List.of(
            new fr.kenlek.jpgen.Member.Field(fr.kenlek.jpgen.ForeignUtils.UNBOUNDED_POINTER.withName("Filename")),
            new fr.kenlek.jpgen.Member.Field(fr.kenlek.jpgen.ForeignUtils.UNBOUNDED_POINTER.withName("Contents")),
            new fr.kenlek.jpgen.Member.Field(java.lang.foreign.ValueLayout.JAVA_INT.withName("Length"))
    ));
    public static final fr.kenlek.jpgen.LayoutData<java.lang.foreign.StructLayout> RECORD_DECL__fr$kenlek$jpgen$clang$posix$CXUnsavedFile = fr.kenlek.jpgen.ForeignUtils.LAYOUT_PROVIDER.createStruct("CXUnsavedFile", java.util.List.of(
            new fr.kenlek.jpgen.Member.Field(fr.kenlek.jpgen.ForeignUtils.UNBOUNDED_POINTER.withName("Filename")),
            new fr.kenlek.jpgen.Member.Field(fr.kenlek.jpgen.ForeignUtils.UNBOUNDED_POINTER.withName("Contents")),
            new fr.kenlek.jpgen.Member.Field(java.lang.foreign.ValueLayout.JAVA_LONG.withName("Length"))
    ));
    public static final java.lang.foreign.GroupLayout RECORD_DECL__fr$kenlek$jpgen$clang$CXUnsavedFile = fr.kenlek.jpgen.Host.select(
            new fr.kenlek.jpgen.Host.Value<>(fr.kenlek.jpgen.Host.OS_WINDOWS, RECORD_DECL__fr$kenlek$jpgen$clang$win32$CXUnsavedFile.layout),
            new fr.kenlek.jpgen.Host.Value<>(fr.kenlek.jpgen.Host.POSIX, RECORD_DECL__fr$kenlek$jpgen$clang$posix$CXUnsavedFile.layout)
    );
    public static final fr.kenlek.jpgen.LayoutData<java.lang.foreign.StructLayout> RECORD_DECL__fr$kenlek$jpgen$clang$win32$CXTUResourceUsageEntry = fr.kenlek.jpgen.ForeignUtils.LAYOUT_PROVIDER.createStruct("CXTUResourceUsageEntry", java.util.List.of(
            new fr.kenlek.jpgen.Member.Field(java.lang.foreign.ValueLayout.JAVA_INT.withName("kind")),
            new fr.kenlek.jpgen.Member.Field(java.lang.foreign.ValueLayout.JAVA_INT.withName("amount"))
    ));
    public static final fr.kenlek.jpgen.LayoutData<java.lang.foreign.StructLayout> RECORD_DECL__fr$kenlek$jpgen$clang$posix$CXTUResourceUsageEntry = fr.kenlek.jpgen.ForeignUtils.LAYOUT_PROVIDER.createStruct("CXTUResourceUsageEntry", java.util.List.of(
            new fr.kenlek.jpgen.Member.Field(java.lang.foreign.ValueLayout.JAVA_INT.withName("kind")),
            new fr.kenlek.jpgen.Member.Field(java.lang.foreign.ValueLayout.JAVA_LONG.withName("amount"))
    ));
    public static final java.lang.foreign.GroupLayout RECORD_DECL__fr$kenlek$jpgen$clang$CXTUResourceUsageEntry = fr.kenlek.jpgen.Host.select(
            new fr.kenlek.jpgen.Host.Value<>(fr.kenlek.jpgen.Host.OS_WINDOWS, RECORD_DECL__fr$kenlek$jpgen$clang$win32$CXTUResourceUsageEntry.layout),
            new fr.kenlek.jpgen.Host.Value<>(fr.kenlek.jpgen.Host.POSIX, RECORD_DECL__fr$kenlek$jpgen$clang$posix$CXTUResourceUsageEntry.layout)
    );
}
