...
public interface CXInclusionVisitor
{
    ...
    void _invoke(java.lang.foreign.MemorySegment included_file, java.lang.foreign.MemorySegment inclusion_stack, int include_len, java.lang.foreign.MemorySegment client_data);
