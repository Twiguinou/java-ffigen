...
public interface CXCursorVisitor
{
    ...
    int _invoke(jpgen.clang.CXCursor cursor, jpgen.clang.CXCursor parent, java.lang.foreign.MemorySegment client_data);
    ...
    {
        return this._invoke(new jpgen.clang.CXCursor(cursor), new jpgen.clang.CXCursor(parent), client_data);
    }
