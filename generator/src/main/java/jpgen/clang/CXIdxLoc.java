...
public record CXIdxLoc(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static CXIdxLoc getAtIndex(java.lang.foreign.MemorySegment buffer, int i)
    {
        return new CXIdxLoc(buffer.asSlice(i * gStructLayout.byteSize(), gStructLayout));
    }
