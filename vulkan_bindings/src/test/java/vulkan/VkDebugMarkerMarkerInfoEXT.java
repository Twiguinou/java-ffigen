...
public record VkDebugMarkerMarkerInfoEXT(java.lang.foreign.MemorySegment ptr)
{
	...
	public static final java.lang.foreign.AddressLayout LAYOUT$pMarkerName = java.lang.foreign.ValueLayout.ADDRESS;
	public static final long OFFSET$pMarkerName = 16L;
	...
	public java.lang.foreign.MemorySegment pMarkerName() {return this.ptr.get(LAYOUT$pMarkerName, OFFSET$pMarkerName);}
	public void pMarkerName(java.lang.foreign.MemorySegment value) {this.ptr.set(LAYOUT$pMarkerName, OFFSET$pMarkerName, value);}
	public java.lang.foreign.MemorySegment pMarkerName_ptr() {return this.ptr.asSlice(OFFSET$pMarkerName, LAYOUT$pMarkerName);}
