...
public interface PFN_vkGetDeviceFaultInfoEXT
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkGetDeviceFaultInfoEXT.class);

	int invoke(java.lang.foreign.MemorySegment device, java.lang.foreign.MemorySegment pFaultCounts, java.lang.foreign.MemorySegment pFaultInfo);
