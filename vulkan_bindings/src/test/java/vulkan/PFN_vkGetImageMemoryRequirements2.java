...
public interface PFN_vkGetImageMemoryRequirements2
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkGetImageMemoryRequirements2.class);
