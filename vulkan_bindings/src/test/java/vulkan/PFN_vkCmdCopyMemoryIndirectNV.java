...
public interface PFN_vkCmdCopyMemoryIndirectNV
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkCmdCopyMemoryIndirectNV.class);

	void invoke(java.lang.foreign.MemorySegment commandBuffer, long copyBufferAddress, int copyCount, int stride);
