...
public interface PFN_vkSubmitDebugUtilsMessageEXT
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkSubmitDebugUtilsMessageEXT.class);

	void invoke(java.lang.foreign.MemorySegment instance, int messageSeverity, int messageTypes, java.lang.foreign.MemorySegment pCallbackData);
