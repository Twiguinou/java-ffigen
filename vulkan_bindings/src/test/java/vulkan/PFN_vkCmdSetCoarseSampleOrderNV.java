...
public interface PFN_vkCmdSetCoarseSampleOrderNV
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkCmdSetCoarseSampleOrderNV.class);

	void invoke(java.lang.foreign.MemorySegment commandBuffer, int sampleOrderType, int customSampleOrderCount, java.lang.foreign.MemorySegment pCustomSampleOrders);
