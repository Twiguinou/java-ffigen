...
public interface PFN_vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR.class);
