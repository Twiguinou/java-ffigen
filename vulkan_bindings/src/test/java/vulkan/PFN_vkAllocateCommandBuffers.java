...
public interface PFN_vkAllocateCommandBuffers
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkAllocateCommandBuffers.class);

	int invoke(java.lang.foreign.MemorySegment device, java.lang.foreign.MemorySegment pAllocateInfo, java.lang.foreign.MemorySegment pCommandBuffers);
