...
public interface PFN_vkQueuePresentKHR
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkQueuePresentKHR.class);

	int invoke(java.lang.foreign.MemorySegment queue, java.lang.foreign.MemorySegment pPresentInfo);
