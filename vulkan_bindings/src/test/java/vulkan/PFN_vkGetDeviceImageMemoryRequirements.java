...
public interface PFN_vkGetDeviceImageMemoryRequirements
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkGetDeviceImageMemoryRequirements.class);
