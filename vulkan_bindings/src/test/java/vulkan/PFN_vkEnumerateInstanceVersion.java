...
public interface PFN_vkEnumerateInstanceVersion
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkEnumerateInstanceVersion.class);

	int invoke(java.lang.foreign.MemorySegment pApiVersion);
