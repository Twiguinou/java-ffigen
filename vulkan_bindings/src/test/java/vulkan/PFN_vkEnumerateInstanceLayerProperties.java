...
public interface PFN_vkEnumerateInstanceLayerProperties
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkEnumerateInstanceLayerProperties.class);

	int invoke(java.lang.foreign.MemorySegment pPropertyCount, java.lang.foreign.MemorySegment pProperties);
