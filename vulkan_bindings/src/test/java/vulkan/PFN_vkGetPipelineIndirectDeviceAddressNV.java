...
public interface PFN_vkGetPipelineIndirectDeviceAddressNV
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkGetPipelineIndirectDeviceAddressNV.class);
