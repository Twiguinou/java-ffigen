...
public interface PFN_vkCreateDebugUtilsMessengerEXT
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkCreateDebugUtilsMessengerEXT.class);

	int invoke(java.lang.foreign.MemorySegment instance, java.lang.foreign.MemorySegment pCreateInfo, java.lang.foreign.MemorySegment pAllocator, java.lang.foreign.MemorySegment pMessenger);
