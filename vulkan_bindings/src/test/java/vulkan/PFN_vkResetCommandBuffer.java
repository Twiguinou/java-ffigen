...
public interface PFN_vkResetCommandBuffer
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkResetCommandBuffer.class);

	int invoke(java.lang.foreign.MemorySegment commandBuffer, int flags);
