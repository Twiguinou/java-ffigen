...
public interface PFN_vkCmdSetViewportWithCount
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkCmdSetViewportWithCount.class);

	void invoke(java.lang.foreign.MemorySegment commandBuffer, int viewportCount, java.lang.foreign.MemorySegment pViewports);
