...
public interface PFN_vkCmdSetViewportWScalingNV
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkCmdSetViewportWScalingNV.class);

	void invoke(java.lang.foreign.MemorySegment commandBuffer, int firstViewport, int viewportCount, java.lang.foreign.MemorySegment pViewportWScalings);
