...
public interface PFN_vkAcquirePerformanceConfigurationINTEL
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkAcquirePerformanceConfigurationINTEL.class);

	int invoke(java.lang.foreign.MemorySegment device, java.lang.foreign.MemorySegment pAcquireInfo, java.lang.foreign.MemorySegment pConfiguration);
