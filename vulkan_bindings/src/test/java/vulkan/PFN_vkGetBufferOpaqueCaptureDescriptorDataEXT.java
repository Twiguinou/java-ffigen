...
public interface PFN_vkGetBufferOpaqueCaptureDescriptorDataEXT
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkGetBufferOpaqueCaptureDescriptorDataEXT.class);
