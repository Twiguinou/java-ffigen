...
public interface PFN_vkCmdSetDepthCompareOp
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkCmdSetDepthCompareOp.class);

	void invoke(java.lang.foreign.MemorySegment commandBuffer, int depthCompareOp);
