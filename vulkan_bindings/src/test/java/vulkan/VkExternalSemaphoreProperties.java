...
public record VkExternalSemaphoreProperties(java.lang.foreign.MemorySegment ptr)
{
	...
	public static final java.lang.foreign.ValueLayout.OfInt LAYOUT$externalSemaphoreFeatures = java.lang.foreign.ValueLayout.JAVA_INT;
	public static final long OFFSET$externalSemaphoreFeatures = 24L;
	...
	public static final java.lang.foreign.StructLayout gStructLayout = java.lang.foreign.MemoryLayout.structLayout(
			...
			LAYOUT$externalSemaphoreFeatures,
			java.lang.foreign.MemoryLayout.paddingLayout(4)
	).withName("VkExternalSemaphoreProperties");
	...
	public int externalSemaphoreFeatures() {return this.ptr.get(LAYOUT$externalSemaphoreFeatures, OFFSET$externalSemaphoreFeatures);}
	public void externalSemaphoreFeatures(int value) {this.ptr.set(LAYOUT$externalSemaphoreFeatures, OFFSET$externalSemaphoreFeatures, value);}
	public java.lang.foreign.MemorySegment externalSemaphoreFeatures_ptr() {return this.ptr.asSlice(OFFSET$externalSemaphoreFeatures, LAYOUT$externalSemaphoreFeatures);}
}
