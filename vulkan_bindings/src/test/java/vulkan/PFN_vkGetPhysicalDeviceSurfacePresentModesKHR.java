...
public interface PFN_vkGetPhysicalDeviceSurfacePresentModesKHR
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkGetPhysicalDeviceSurfacePresentModesKHR.class);

	int invoke(java.lang.foreign.MemorySegment physicalDevice, java.lang.foreign.MemorySegment surface, java.lang.foreign.MemorySegment pPresentModeCount, java.lang.foreign.MemorySegment pPresentModes);
