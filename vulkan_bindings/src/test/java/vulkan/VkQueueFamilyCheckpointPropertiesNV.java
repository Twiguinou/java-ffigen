...
public record VkQueueFamilyCheckpointPropertiesNV(java.lang.foreign.MemorySegment ptr)
{
    ...
    public static final java.lang.foreign.ValueLayout.OfInt LAYOUT$checkpointExecutionStageMask = java.lang.foreign.ValueLayout.JAVA_INT;
    ...
    public int checkpointExecutionStageMask() {return this.ptr.get(LAYOUT$checkpointExecutionStageMask, OFFSET$checkpointExecutionStageMask);}
    public void checkpointExecutionStageMask(int value) {this.ptr.set(LAYOUT$checkpointExecutionStageMask, OFFSET$checkpointExecutionStageMask, value);}
