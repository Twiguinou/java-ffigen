...
public interface PFN_vkGetDisplayPlaneSupportedDisplaysKHR
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkGetDisplayPlaneSupportedDisplaysKHR.class);

	int invoke(java.lang.foreign.MemorySegment physicalDevice, int planeIndex, java.lang.foreign.MemorySegment pDisplayCount, java.lang.foreign.MemorySegment pDisplays);
