...
public interface PFN_vkGetPhysicalDeviceSurfaceSupportKHR
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkGetPhysicalDeviceSurfaceSupportKHR.class);

	int invoke(java.lang.foreign.MemorySegment physicalDevice, int queueFamilyIndex, java.lang.foreign.MemorySegment surface, java.lang.foreign.MemorySegment pSupported);
