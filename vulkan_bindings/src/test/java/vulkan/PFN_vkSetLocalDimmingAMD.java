...
public interface PFN_vkSetLocalDimmingAMD
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkSetLocalDimmingAMD.class);

	void invoke(java.lang.foreign.MemorySegment device, java.lang.foreign.MemorySegment swapChain, int localDimmingEnable);
