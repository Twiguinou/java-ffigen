...
public interface PFN_vkCopyAccelerationStructureKHR
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkCopyAccelerationStructureKHR.class);
