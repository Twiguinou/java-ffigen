...
public interface PFN_vkCmdSetScissor
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkCmdSetScissor.class);

	void invoke(java.lang.foreign.MemorySegment commandBuffer, int firstScissor, int scissorCount, java.lang.foreign.MemorySegment pScissors);
