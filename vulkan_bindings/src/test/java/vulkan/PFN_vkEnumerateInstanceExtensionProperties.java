...
public interface PFN_vkEnumerateInstanceExtensionProperties
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkEnumerateInstanceExtensionProperties.class);

	int invoke(java.lang.foreign.MemorySegment pLayerName, java.lang.foreign.MemorySegment pPropertyCount, java.lang.foreign.MemorySegment pProperties);
