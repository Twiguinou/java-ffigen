...
public record VkDeviceGroupDeviceCreateInfo(java.lang.foreign.MemorySegment ptr)
{
	...
	public static final java.lang.foreign.AddressLayout LAYOUT$pPhysicalDevices = java.lang.foreign.ValueLayout.ADDRESS;
	public static final long OFFSET$pPhysicalDevices = 24L;
	...
	public java.lang.foreign.MemorySegment pPhysicalDevices() {return this.ptr.get(LAYOUT$pPhysicalDevices, OFFSET$pPhysicalDevices);}
	public void pPhysicalDevices(java.lang.foreign.MemorySegment value) {this.ptr.set(LAYOUT$pPhysicalDevices, OFFSET$pPhysicalDevices, value);}
	public java.lang.foreign.MemorySegment pPhysicalDevices_ptr() {return this.ptr.asSlice(OFFSET$pPhysicalDevices, LAYOUT$pPhysicalDevices);}
}
