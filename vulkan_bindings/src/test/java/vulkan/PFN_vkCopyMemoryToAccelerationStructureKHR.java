...
public interface PFN_vkCopyMemoryToAccelerationStructureKHR
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkCopyMemoryToAccelerationStructureKHR.class);
