...
public interface PFN_vkEndCommandBuffer
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkEndCommandBuffer.class);

	int invoke(java.lang.foreign.MemorySegment commandBuffer);
