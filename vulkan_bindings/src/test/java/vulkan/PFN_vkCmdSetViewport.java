...
public interface PFN_vkCmdSetViewport
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkCmdSetViewport.class);

	void invoke(java.lang.foreign.MemorySegment commandBuffer, int firstViewport, int viewportCount, java.lang.foreign.MemorySegment pViewports);
