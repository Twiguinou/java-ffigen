...
public interface PFN_vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT.class);
