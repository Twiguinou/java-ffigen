...
public record VkRenderingAreaInfoKHR(java.lang.foreign.MemorySegment ptr)
{
    ...
    ).withName("VkRenderingAreaInfoKHR");

    public VkRenderingAreaInfoKHR(java.lang.foreign.SegmentAllocator allocator)
    {
