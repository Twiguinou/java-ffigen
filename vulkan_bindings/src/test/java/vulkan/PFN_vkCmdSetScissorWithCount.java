...
public interface PFN_vkCmdSetScissorWithCount
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkCmdSetScissorWithCount.class);

	void invoke(java.lang.foreign.MemorySegment commandBuffer, int scissorCount, java.lang.foreign.MemorySegment pScissors);
