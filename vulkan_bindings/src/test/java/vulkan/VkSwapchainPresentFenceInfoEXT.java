...
public record VkSwapchainPresentFenceInfoEXT(java.lang.foreign.MemorySegment ptr)
{
	...
	public static final java.lang.foreign.AddressLayout LAYOUT$pFences = java.lang.foreign.ValueLayout.ADDRESS;
	public static final long OFFSET$pFences = 24L;
	...
	public java.lang.foreign.MemorySegment pFences() {return this.ptr.get(LAYOUT$pFences, OFFSET$pFences);}
	public void pFences(java.lang.foreign.MemorySegment value) {this.ptr.set(LAYOUT$pFences, OFFSET$pFences, value);}
	public java.lang.foreign.MemorySegment pFences_ptr() {return this.ptr.asSlice(OFFSET$pFences, LAYOUT$pFences);}
}
