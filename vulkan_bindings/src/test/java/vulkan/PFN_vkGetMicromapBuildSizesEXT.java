...
public interface PFN_vkGetMicromapBuildSizesEXT
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkGetMicromapBuildSizesEXT.class);

	void invoke(java.lang.foreign.MemorySegment device, int buildType, java.lang.foreign.MemorySegment pBuildInfo, java.lang.foreign.MemorySegment pSizeInfo);
