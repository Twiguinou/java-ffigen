...
public interface PFN_vkCopyMicromapToMemoryEXT
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkCopyMicromapToMemoryEXT.class);
