...
public interface PFN_vkGetMemoryFdPropertiesKHR
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkGetMemoryFdPropertiesKHR.class);

	int invoke(java.lang.foreign.MemorySegment device, int handleType, int fd, java.lang.foreign.MemorySegment pMemoryFdProperties);
