...
public interface PFN_vkGetImageSparseMemoryRequirements2
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkGetImageSparseMemoryRequirements2.class);
