...
public interface PFN_vkBeginCommandBuffer
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkBeginCommandBuffer.class);

	int invoke(java.lang.foreign.MemorySegment commandBuffer, java.lang.foreign.MemorySegment pBeginInfo);
