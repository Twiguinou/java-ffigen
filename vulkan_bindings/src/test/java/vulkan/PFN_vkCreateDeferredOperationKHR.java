...
public interface PFN_vkCreateDeferredOperationKHR
{
	...
	java.lang.invoke.MethodHandle gUpcallStub = jpgen.NativeTypes.initUpcallStub(gDescriptor, "invoke", PFN_vkCreateDeferredOperationKHR.class);

	int invoke(java.lang.foreign.MemorySegment device, java.lang.foreign.MemorySegment pAllocator, java.lang.foreign.MemorySegment pDeferredOperation);
